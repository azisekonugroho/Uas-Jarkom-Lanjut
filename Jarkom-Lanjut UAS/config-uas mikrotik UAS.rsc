...
/interface vlan
add interface=bridge1 name=vlan991 vlan-id=991
...
set 5 default-vlan-id=991 vlan-header=always-strip vlan-mode=secure
...
add bridge=bridge1 tagged=ether1,bridge1 vlan-ids=991
